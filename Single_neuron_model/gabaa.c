...
#define R1 _p[6]
#define R1_columnindex 6
#define lastrelease _p[7]
#define lastrelease_columnindex 7
#define _g _p[8]
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 156 in file gabaa.mod:\n	SOLVE release\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
static const char* nmodl_file_text = 
  ...
  "  the fit was performed using a simplex algorithm (see Destexhe et\n"
  ...
  "	POINT_PROCESS GABAa\n"
  "	POINTER pre\n"
  "	RANGE C, R, R0, R1, g, gmax, lastrelease, i\n"
  ...
  "	Beta	= 0.184	(/ms)		: backward (unbinding) rate\n"

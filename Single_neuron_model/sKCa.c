...
#define isKCa _p[1]
#define isKCa_columnindex 1
#define w _p[2]
#define w_columnindex 2
#define ek _p[3]
#define ek_columnindex 3
#define ki _p[4]
#define ki_columnindex 4
#define cai _p[5]
...
#define winf _p[8]
#define winf_columnindex 8
#define wtau _p[9]
#define wtau_columnindex 9
#define Dw _p[10]
#define Dw_columnindex 10
#define _g _p[11]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 sKCa sKCa.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  integrate();
 if(error){fprintf(stderr,"at line 66 in file sKCa.mod:\n	SOLVE integrate METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "sKCa.mod";
static const char* nmodl_file_text = 

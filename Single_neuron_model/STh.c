...
#define nrn_init _nrn_init__STh
#define _nrn_initial _nrn_initial__STh
#define nrn_cur _nrn_cur__STh
#define _nrn_current _nrn_current__STh
#define nrn_jacob _nrn_jacob__STh
#define nrn_state _nrn_state__STh
#define _net_receive _net_receive__STh 
...
#define dt _nt->_dt
#define gpas _p[0]
#define gpas_columnindex 0
#define epas _p[1]
#define epas_columnindex 1
#define ipas _p[2]
#define ipas_columnindex 2
#define v _p[3]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 STh STh.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "passive membrane properties for STh";
...
#if NMODL_TEXT
static const char* nmodl_filename = "STh.mod";
static const char* nmodl_file_text = 

...
#define nrn_init _nrn_init__axnode75
#define _nrn_initial _nrn_initial__axnode75
#define nrn_cur _nrn_cur__axnode75
#define _nrn_current _nrn_current__axnode75
#define nrn_jacob _nrn_jacob__axnode75
#define nrn_state _nrn_state__axnode75
#define _net_receive _net_receive__axnode75 
#define evaluate_fct evaluate_fct__axnode75 
#define states states__axnode75 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_axnode75", _hoc_setdata,
 "Exp_axnode75", _hoc_Exp,
 "evaluate_fct_axnode75", _hoc_evaluate_fct,
 "vtrap_axnode75", _hoc_vtrap,
 "vtrap8_axnode75", _hoc_vtrap8,
 "vtrap7_axnode75", _hoc_vtrap7,
 "vtrap6_axnode75", _hoc_vtrap6,
 "vtrap2_axnode75", _hoc_vtrap2,
 "vtrap1_axnode75", _hoc_vtrap1,
 0, 0
};
#define Exp Exp_axnode75
#define vtrap vtrap_axnode75
#define vtrap8 vtrap8_axnode75
#define vtrap7 vtrap7_axnode75
#define vtrap6 vtrap6_axnode75
#define vtrap2 vtrap2_axnode75
#define vtrap1 vtrap1_axnode75
...
#define asC asC_axnode75
 double asC = -5;
#define asB asB_axnode75
 double asB = -27;
#define asA asA_axnode75
 double asA = 0.3;
#define ahC ahC_axnode75
 double ahC = 11;
#define ahB ahB_axnode75
 double ahB = 114;
#define ahA ahA_axnode75
 double ahA = 0.062;
#define amC amC_axnode75
 double amC = 10.3;
#define amB amB_axnode75
 double amB = 21.4;
#define amA amA_axnode75
 double amA = 1.86;
#define ampC ampC_axnode75
 double ampC = 10.2;
#define ampB ampB_axnode75
 double ampB = 27;
#define ampA ampA_axnode75
 double ampA = 0.01;
#define bsC bsC_axnode75
 double bsC = -1;
#define bsB bsB_axnode75
 double bsB = 10;
#define bsA bsA_axnode75
 double bsA = 0.03;
#define bhC bhC_axnode75
 double bhC = 13.4;
#define bhB bhB_axnode75
 double bhB = 31.8;
#define bhA bhA_axnode75
 double bhA = 2.3;
#define bmC bmC_axnode75
 double bmC = 9.16;
#define bmB bmB_axnode75
 double bmB = 25.7;
#define bmA bmA_axnode75
 double bmA = 0.086;
#define bmpC bmpC_axnode75
 double bmpC = 10;
#define bmpB bmpB_axnode75
 double bmpB = 34;
#define bmpA bmpA_axnode75
 double bmpA = 0.00025;
#define vtraub vtraub_axnode75
 double vtraub = -80;
#define vshift vshift_axnode75
 double vshift = 5;
 ...
 "gnapbar_axnode75", "mho/cm2",
 "gnabar_axnode75", "mho/cm2",
 "gkbar_axnode75", "mho/cm2",
 "gl_axnode75", "mho/cm2",
 "ena_axnode75", "mV",
 "ek_axnode75", "mV",
 "el_axnode75", "mV",
 "inap_axnode75", "mA/cm2",
 "ina_axnode75", "mA/cm2",
 "ik_axnode75", "mA/cm2",
 "il_axnode75", "mA/cm2",
 0,0
 ...
 "vshift_axnode75", &vshift_axnode75,
 "vtraub_axnode75", &vtraub_axnode75,
 "ampA_axnode75", &ampA_axnode75,
 "ampB_axnode75", &ampB_axnode75,
 "ampC_axnode75", &ampC_axnode75,
 "bmpA_axnode75", &bmpA_axnode75,
 "bmpB_axnode75", &bmpB_axnode75,
 "bmpC_axnode75", &bmpC_axnode75,
 "amA_axnode75", &amA_axnode75,
 "amB_axnode75", &amB_axnode75,
 "amC_axnode75", &amC_axnode75,
 "bmA_axnode75", &bmA_axnode75,
 "bmB_axnode75", &bmB_axnode75,
 "bmC_axnode75", &bmC_axnode75,
 "ahA_axnode75", &ahA_axnode75,
 "ahB_axnode75", &ahB_axnode75,
 "ahC_axnode75", &ahC_axnode75,
 "bhA_axnode75", &bhA_axnode75,
 "bhB_axnode75", &bhB_axnode75,
 "bhC_axnode75", &bhC_axnode75,
 "asA_axnode75", &asA_axnode75,
 "asB_axnode75", &asB_axnode75,
 "asC_axnode75", &asC_axnode75,
 "bsA_axnode75", &bsA_axnode75,
 "bsB_axnode75", &bsB_axnode75,
 "bsC_axnode75", &bsC_axnode75,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 axnode75 AXNODE75.mod\n");
...
static int  evaluate_fct ( _threadargsprotocomma_ double _lv ) {
   double _la , _lb , _lv2 ;
 _lv2 = _lv - vshift ;
   _la = q10_1 * vtrap1 ( _threadargscomma_ _lv2 ) ;
   _lb = q10_1 * vtrap2 ( _threadargscomma_ _lv2 ) ;
   tau_mp = 1.0 / ( _la + _lb ) ;
   mp_inf = _la / ( _la + _lb ) ;
   _la = q10_1 * vtrap6 ( _threadargscomma_ _lv2 ) ;
   _lb = q10_1 * vtrap7 ( _threadargscomma_ _lv2 ) ;
   tau_m = 1.0 / ( _la + _lb ) ;
   m_inf = _la / ( _la + _lb ) ;
   _la = q10_2 * vtrap8 ( _threadargscomma_ _lv2 ) ;
   _lb = q10_2 * bhA / ( 1.0 + Exp ( _threadargscomma_ - ( _lv2 + bhB ) / bhC ) ) ;
   tau_h = 1.0 / ( _la + _lb ) ;
   h_inf = _la / ( _la + _lb ) ;
   _la = q10_3 * asA / ( Exp ( _threadargscomma_ ( _lv2 - vtraub + asB ) / asC ) + 1.0 ) ;
   _lb = q10_3 * bsA / ( Exp ( _threadargscomma_ ( _lv2 - vtraub + bsB ) / bsC ) + 1.0 ) ;
   tau_s = 1.0 / ( _la + _lb ) ;
   s_inf = _la / ( _la + _lb ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "AXNODE75.mod";
static const char* nmodl_file_text = 
